...
const Menu = (props) => {
    return (
        <>
            <div className="card mb-4 d-flex flex-column align-items-start" style={{ width: "9.79rem", height: "11.6rem", background: `${props.bg}` }} onClick={() => props.setOrder(props.name + props.price)}>
